...
<footer id="contacto">
    <div class="contenedor footer-contect">
        <div class="contacto-us">
            <h2 class="brand">Municipalidad de Las Lomitas</h2>
            <p>Contacto:128748465359895 <br>
            Direccion:------------- <br>
            Email: laslomitas@gmail.com</p>
        </div>
        <div class="social-media">
            <a href="/" class="social-media-iconos">
...
<style>
footer{
    background: rgba(145, 199, 200, 0.667);
...
.brand{
 ...
 .social-media-iconos:hover{
     background: #fff;
     color: #0f0303;
 }

 .social-media-iconos i{
     font-size: 30px;
     line-height: 60px;
 }
 .line{
